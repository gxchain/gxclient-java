...
public class RPC {
    ...
    public static final String GET_KEY_REFERENCES = "get_key_references";

    public static final String LOOKUP_ASSET_SYMBOLS = "lookup_asset_symbols";

    public static final String BROADCAST_TRANSACTION_SYNCHRONOUS = "broadcast_transaction_synchronous";
    public static final String GET_TABLE_ROWS = "get_table_rows";
    public static final String GET_TABLE_ROWS_EX = "get_table_rows_ex";
